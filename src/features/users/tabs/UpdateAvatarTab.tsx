      ...
      >
        <Grid item md={6} xs={1}>
          <Stack direction="row" spacing={2} justifyContent={"center"}>
            <Avatar
              ...
              sx={{ width: 200, height: 200, bgcolor: yellow[800] }}
              variant="rounded"
            />
          </Stack>
        </Grid>
        <Grid item md={6} xs={1}>
          <Box>
            ...
            {file && (
              <div>
                ...
                <Cropper
                  ...
                  guides={true}
                />
                <Button variant="contained" onClick={handleCrop} sx={{ my: 1 }}>
                  Cắt Ảnh
                </Button>
              </div>
            )}
            {croppedImageUrl && (
              <div>
                <Typography variant="subtitle1">- Ảnh đã cắt -</Typography>
                <img
                  src={croppedImageUrl}
                  alt=""
                  style={{
                ...
                />
                <Divider sx={{ my: 1 }} />
                <Button variant="contained" onClick={handleFileUpdate}>
                  CẬP NHẬT ẢNH
                </Button>
              </div>
            )}
