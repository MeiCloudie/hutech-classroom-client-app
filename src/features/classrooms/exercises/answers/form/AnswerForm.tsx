...
const AnswerForm = (props: AnswerFormProps) => {
    ...
    useEffect(() => {
        if (props.answer)
            setAnswerFormValues(new AnswerFormValues(props.answer));
        else if (answerId)
            answerStore.get(answerId).then(() => {
                if (answerStore.selectedItem) {
                    setAnswerFormValues(
                        new AnswerFormValues(answerStore.selectedItem)
                    );
                }
            });
                        ...
                        fieldConfigs={[
                            {
                                ...
                                props: {
                                    ...
                                    placeholder:
                                        'Hãy nhập mô tả câu trả lời tại đây!',
                            ...
                            },
                            {
                                ...
                                props: {
                                    label: 'Liên Kết',
                                    placeholder:
                                        'Hãy thêm đường dẫn liên kết tại đây!',
                                    rows: 5,
                                },
                            },
                            {
