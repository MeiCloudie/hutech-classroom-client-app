            ...
            <CardContent>
                ...
                >
                    ...
                    <Typography variant='body2' color='red' gutterBottom>
                        ...
                        {new Date(
                            `${dayjs.utc(props.exercise.deadline)}`
                        ).toLocaleString('vi-VN', {
                            day: '2-digit',
                            month: '2-digit',
                            year: 'numeric',
                ...
                <Box sx={{ mt: 2, mb: 2 }}>
                    ...
                    <Typography
                        ...
                        dangerouslySetInnerHTML={{
                            __html: props.exercise.instruction,
                        }}
                        style={{ padding: '0' }}
                    ></Typography>
                </Box>
                ...
                <Box sx={{ mt: 2, mb: 2 }}>
                    ...
                    <Typography
                        variant='body2'
                        dangerouslySetInnerHTML={{
                            __html: props.exercise.criteria,
                        }}
                        style={{ padding: '0' }}
                    ></Typography>
                </Box>
